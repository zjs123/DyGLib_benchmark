...
def get_node_classification_args():
    ...
    parser.add_argument('--dataset_name', type=str, help='dataset to be used', default='Amazon_movies', choices=['Amazon_movies', 'Enron', 'GDELT', 'Googlemap_CT', 'ICEWS1819', 'Stack_elec', 'Stack_english', 'Stack_ubuntu', 'Yelp', 'Cite_HepTH'])
